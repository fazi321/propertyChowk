          ...
          <div class="city-block">
            ...
            <div class="area-input" id="input">
              ...
              <div class="dropdown" v-if="dropdownCities">
                ...
                <div class="city-list" v-if="!finalData.city">
                  <ul>
        ...
        <div>
          <section class="address-block">
            <section class="area-detail">
              ...
              <div class="city-block">
                <!-- input block -->
                <div class="check-buttons input-set" id="input-society">
                  <div class="title">
                    <h1>Society</h1>
                  </div>
                  <div>
                    <div>
                      <input
                        ...
                        :readonly="!finalData.city"
                      />
                    </div>
                  </div>
                </div>
                <div class="area-input society-lists">
                  <!-- <div>
  ...
  methods: {
    ...
    hotAdd(v) {
      ...
      if (v == "h") {
        ...
        this.finalData.featured = true;
        this.finalData.feature_type = 1;
        // delete this.finalData.superhot_ads;
      } else {
        this.finalData.featured = true;
        this.finalData.feature_type = 0;
    ...
    submit() {
      if (this.finalData.optional_number) {
        this.finalData.optional_number =
          this.finalData.optional_number.toString();
      }
    ...
    openDropdownSociety() {
      if (!this.finalData.city && !this.$route.query.city) {
    ...
    typeSelect(type) {
      if (type == "rent") {
        this.finalData.purpose = 1;
      } else {
        delete this.finalData.purpose;
      }
      this.category = type;
    },
    addBasicData() {
  ...
  computed: {
    searchCities() {
      ...
      return search.filter((city) =>
        city.name.toLowerCase().startsWith(this.finalData.city.toLowerCase())
      );
    },
    searchSocietyFilter() {
      var search = this.society.society;
      return search.filter((city) =>
        city.toLowerCase().startsWith(this.finalData.society.toLowerCase())
      );
    },
    info() {
